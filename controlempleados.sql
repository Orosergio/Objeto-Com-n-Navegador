...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-10-2020 a las 00:05:00
...
(2, 'JOSE LUIS RODRIGUEZ', 'GERENTE COMERCIAL', 'Ventas', 1),
...
(102, 'JUAN GABRIEL', 'DOCTOR', 'ENFERMERIA', 1),
(103, 'GABRIEL', 'ING SIS', 'IT', 0),
(104, 'IRMA MONTER', 'CAJERA', 'VENTAS', 0),
(105, 'RANDALL CHOC', 'ANALISTA DE SISTEMAS', 'IT', 0),
(106, 'ESTANISLAO', 'PROGRAMADOR', 'SISTEMAS', 0),
(107, 'SERGIO', 'GERENTE', 'VENTAS', 0),
(108, 'CARLOS', 'PROGRAMADOR', 'SISTEMAS', 0),
(109, 'JOSE Lopez', 'ventas', 'gerente', 0),
(110, 'Jose ', 'vendero', 'ventas', 0);
...
--
ALTER TABLE `empleados`
  MODIFY `codigo_empleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
